use crate::geo_helpers::{
    ...
    invert_multi_polygon, limit_angle, linestring_intersection, make_polygon_valid,
};
...
use anyhow::Result;
use geo::{
    Area, Closest, ClosestPoint, Coord, Distance, Euclidean, Length, LineInterpolatePoint,
...
pub struct MapModel {
    ...
    pub boundaries: BTreeMap<String, NeighbourhoodStats>,
}
...
impl NeighbourhoodStats {
    pub fn new(definition: NeighbourhoodDefinition) -> Self {
        let boundary_stats = BoundaryStats::new(&definition.geometry);
        Self {
            definition,
            boundary_stats,
        }
