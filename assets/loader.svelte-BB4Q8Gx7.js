let e=[["Ceci est la seconde version de l'outil A/B Street LTN, ",[0,"un projet open source"],". Cette version, nommée Connected Neighbourhoods Tool, a été financé par ",[1,"Transport Scotland"]," et conçue par ",[2,"Sustrans Scotland"],`.
L'équipe est constituée de :`],["Dustin Carlino, développeur principal et directeur de ",[0,"A/B Street Ltd"]],[[0,"Michael Kirk"],`,
développeur logiciel`],["Sustrans Scotland ",[0,[0,[0,"Congying (Cici) Hu"],", mobility planner"]," ",[1,[0,"Angus Calder"],", senior mobility planner"]," ",[2,"Michael Naysmith, senior mobility planner (project manager)"]," ",[3,[0,"Matthew Davis"],", principal mobility planner"]]],[`This second version of the tool is an evolution from the original A/B Street
...
within the neighbourhood. Drag the pin around to change that destination.`,"Itinéraire avant changements",["No possible route ( ",[0,"This is usually a known software bug"]," )"],"Survolez une route pour comparer","Itinéraire après changements",["Time ratio: ",0],"X","Calculating impact",[`This mode estimates the impact of all your changes on traffic around the
...
through it that've changed.`,["Only show roads with at least this many daily trips before or after ",[0]],[0," before, ",1," after"],"Déplacez les marqueurs pour créer un itinéraire",["Facteur de ralentissement pour les routes principales : ",0," ",[0]],`Increase to see how drivers may detour in heavy traffic. 1 means
free-flow.`,"Ajuster les limites","Valider","Annuler","No shortcuts here","Cliquez sur une route pour voir les raccourcis",`This shows all possible shortcuts crossing the blue road you've chosen.
...
view lets you understand the limits of this assumption.`,"Sélectionner une autre route",["Ce raccourci est ",[0,0,"x"]," plus long que l’itinéraire le plus court. Toutes routes confondues, pas seulement ce quartier."],[0," raccourci(s) par ",1],["Route principale : ",0],"Help",["Area ",[0]],[0," km²"],["SIMD ",[0]],["quintile ",0],["Population density ",[0]],[0," people / km²"],["Car ownership ",[0]],[0," of households"],["POI density ",[0]],[0," / km²"],["Collision density ",[0]],["Overall prioritisation score ",[0]],"ArrowLeft","ArrowRight","Left","Précédent","Right","Suivant","Street view",["Click the map to see street view ",[0]," ",[1]," ",[2,"Street view source"]," ",[3,[0]," Google Street View"]," ",[4,[0]," Bing Streetside"]],["Please name this copy of project ",0],["Projet : ",0],"Télécharger le projet en GeoJSON","Exporter","Faire une copie de ce projet","Copier le projet","Ouvrir un autre projet",[0," nouveau(x) filtre(s) modaux ajouté(s)"],[0," filtre(s) modaux existant(s) supprimé(s)"],[0," sens de circulation modifié(s)"],["Les données de la carte sont du ",0],["If this area has changed since then, please contact ",[0,"dabreegster@gmail.com"]," to use newer OpenStreetMap data."],"Debug route-snapper",["Êtes-vous sûr de vouloir supprimer le quartier ",0," ? Annulation impossible."],["Renommer le quartier ",0," en ?"],"Quartiers","Renommer le quartier","Supprimer le quartier",[[0]," Ajouter un nouveau quartier"],`Compare the prioritisation or individual metrics across your
neighbourhoods.`,[[0,"Population density:"]," ",0,` people
/ km²`],[[0,"Pedestrian and cyclist collisions:"]," ",0," / km²"],[[0,"Points of interest:"]," ",0," / km²"],"Global version","Scotland","England",[`L'outil LTN peut être utilisé partout dans le monde. Certaines régions ont des jeux de données additionnels.
Si vous voulez améliorer l'outil, merci de contacter Dustin par e-mail à `,[0,"dabreegster@gmail.com"],"."],["LAD_",0],"Choose a boundary below or on the map to begin:","Road labels",["Click to start a new project in ",0],"LAD_","Charger un projet à partir d'un fichier","Chargement d'OSM",["Nom du projet : ",[0]],["Charger une zone pré-générée : ",[0]],"ou...",["Êtes-vous sûr de vouloir supprimer le projet ",0," ? Annulation impossible."],["Renommer projet ",0," en ?"],"Outil LTN","Lire le guide d'utilisation","Vos projets","Renommer le projet","Supprimer le projet","Commencer un nouveau projet","Nouveau projet","En attente du chargement de MapLibre et WASM...","Choisissez un filter modal à placer sur les rues","Confirmer","Remove diagonal filter",[[0,"❌"]," ",[1]," Delete diagonal filter"],"Rotate diagonal filter",[[0,"↻"]," ",[1]," Rotate diagonal filter"],"Add diagonal filter",[[0,"+"]," ",[1]," Add diagonal filter"],[[0,"Cliquez et déplacez"]," pour bouger"],[[0,"Clic droit"]," pour supprimer"],[[0,"Cliquez"]," pour re-classifier toute la selection"],"Lignes de bus",["These are all ",[0,"bus routes"]," according to OpenStreetMap."],"Existing cycling infrastructure","Data from NPT","Cycling safety Level of Service","Other","Estimated traffic","Traffic volume category","Level of Service","Infrastructure type","Mixed Traffic Street","Couches","Filtres modaux et interdictions de tourner existants","Metrics","Public transport integration","Active travel","Basemap","MapTiler Dataviz","MapTiler Streets","MapTiler Satellite","OS Open Zoomstack","Outils de débogage","POIs",["See Scottish data sources for ",[0,"schools"]," , ",[1,"GP practices"]," , and ",[2,"hospitals"]," . Other data is from ",[3,"OpenStreetMap"]," ."],"SIMD","Less deprived","More deprived",["This shows the Scottish Index of Multiple Deprivation (SIMD) from ",[0,"2020 data"],` . SIMD combines different domains: income; employment; health; education, skills
...
copy a project and switch between projects.`,"Appendix","Changelog",["As this tool is updated, major changes will be described here. See ",[0,"Github"]," for detailed changes."],"v1, 4 June 2025 - first main release",["12 June 2025 - detecting more shortcuts (see ",[0,"details"],") and more conveniently reclassify main roads along a route (see ",[1,"details"],")"],["16 June 2025 - show a neighbourhood before any edits (see ",[0,"details"],")"],["30 June 2025 - copy and switch projects quickly (see ",[0,"details"],")"],["6 July 2025 - improve styling for pedestrianized areas (see ",[0,"details"],")"],"Credits","Table of Contents","Polygon","Cliquez sur la carte pour ajouter trois points. Puis ajustez les points ou ajoutez-en plus.",[[0]," Aimanter les limites aux routes"],"Annuler",["Annuler (",0,")"],[[0,"Click"]," to toggle snapping"],[0," shortcuts through ",1," (",2," mph)"],["Main road: ",0," (",1," mph)"],"Feature","LineString","INPUT","Debug","Outils de modifications",[[0]," Masquer les modifications"],"Ajouter un filtre modal (raccourci clavier 1)","Ajouter un filtre modal","Définir un sens-unique (raccourci clavier 2)","Inverser les sens","Interdiction de tourner (raccourci clavier 3)","Interdiction de tourner","Redéfinir les routes principales (raccourci clavier 4)","Change main/minor roads","Annuler Ctrl+Z",["Annuler (",0,") Ctrl+Z"],"Rétablir Ctrl+Y",["Rétablir (",0,") Ctrl+Y"],"Ajouter un filtre modal","Les filtres modaux limitent le type de véhicules qui peuvent circuler sur un segment de route. Leur utilisation permet d’empêcher que le quartier serve de raccourci. Placez les stratégiquement.","Changer le type de filtre modal","Ajouter plusieurs filtres modaux le long d'une ligne","Ajouter le long d'une ligne","Définir un sens-unique","Cliquez sur un segment de route pour changer son sens. Cela va changer le sens du flux de circulation sur cette route.","Pour limiter certaines girations, commencez par cliquer sur la route source, puis sur la route destination. Le trafic ne pourra plus tourner de la rue source vers la rue destination.","Redéfinir les routes principales",[[0,"Les routes principales"],`, dessinées en gris, ont étés définies automatiquement
à partir de données issues d'`,[1,"OpenStreetMap"],", vous pouvez toutefois redéfinir un segment de route en cliquant dessus."],`Les routes principales sont typiquement plus adaptées pour un plus
gros volume de circulation que les routes résidentielles.`,"Cliquez sur une route pour la redéfinir","Changer un segment","Redéfinir plusieurs routes en dessinant un tracé qui les suit","Définir un tracé comme route principale","Déclasser la route principales","Déclasser toutes les routes principales",`Certaines zones du quartier ne sont pas accessibles en voiture, affichées en
rouge`,"Style de la carte",[[0]," Animer les raccourcis",[1,"1"]],[[0]," Afficher les entrées des cellules",[1,"2"]],[[0]," Épaisseur proportionnelle aux raccourcis",[1,"1"]],"Afficher :","Raccourcis","Cellules","Modifications (filtres ou sens)","Limites de vitesse","Statistiques du quartier",[[0]," Cliquez pour ajouter un filtre modal"],"Cliquez pour changer le sens","Cliquez pour définir une route principale ou non","Click to create a turn restriction from here","Click to delete filter","Click to delete turn restriction","Add turn restriction",[[0]," Create a turn restriction from ",0," to ",1],["Language ",[0,[0,"English"]," ",[1,"Français"]," ",[2,"Magyar"]]],[[0]," Langue ",[1,[0,"English"]," ",[1,"Français"]," ",[2,"Magyar"]]],[`The Connected Neighbourhood Tool helps you design a Low-Traffic
Neighbourhood (LTN). This guide is written specifically for the Scottish
...
quickly copy a project and switch between projects.`,"Measurement units",["Impériale (mph) ",[0]," Métrique (km/h)"],["Limitations de vitesse (",0,")"],[0," shortcuts through ",1," (",2,")"],["Main road: ",0," (",1,")"],[[0]," Language"],"English","Français","Magyar","Unités de vitesse",[[0]," Masquer les petites cellules",[1,"3"]],"Pour l'instant vide. Cliquez sur une zone colorée pour commencer.",null,[`3 October 2025 - allow small cells with service roads to be hidden
