...
copy a project and switch between projects.`,"Appendix","Changelog",["As this tool is updated, major changes will be described here. See ",[0,"Github"]," for detailed changes."],"v1, 4 June 2025 - first main release",["12 June 2025 - detecting more shortcuts (see ",[0,"details"],") and more conveniently reclassify main roads along a route (see ",[1,"details"],")"],["16 June 2025 - show a neighbourhood before any edits (see ",[0,"details"],")"],["30 June 2025 - copy and switch projects quickly (see ",[0,"details"],")"],["6 July 2025 - improve styling for pedestrianized areas (see ",[0,"details"],")"],"Credits","Table of Contents","Polygon","Click the map to add three points. Then adjust the points or add more.",[[0]," Snap boundary to roads"],"Undo",["Undo (",0,")"],[[0,"Click"]," to toggle snapping"],[0," shortcuts through ",1," (",2," mph)"],["Main road: ",0," (",1," mph)"],"Feature","LineString","INPUT","Debug","Outils de modifications",[[0]," Masquer les modifications"],"Ajouter un filtre modal (raccourci clavier 1)","Ajouter un filtre modal","Définir un sens-unique (raccourci clavier 2)","Inverser les sens","Restreindre les girations (raccourci clavier 3)","Restreindre les girations","Re-classifier les routes principales (raccourci clavier 4)","Change main/minor roads","Annuler Ctrl+Z",["Annuler (",0,") Ctrl+Z"],"Rétablir Ctrl+Y",["Rétablir (",0,") Ctrl+Y"],"Ajouter un filtre modal","Les filtres modaux limitent le type de traffic qui peut circuler par une segment de route.Placez les stratégiquement pour dissuader d'utiliser le quartier comme un raccourci.","Changer le type de filtre modal","Ajouter plusieurs filtres modaux le long d'une ligne","Ajouter le long d'une ligne","Définir un sens-unique","Cliquez sur un segment de route pour changer son sens. Cela va changer le sens du flux de circulation sur cette route.","Pour limiter certaines girations, commencez par cliquer sur la route source, puis sur la route destination. Le trafic le pourra plus tourner de la rue source vers la rue destination.","Re-classifier les routes principales",[[0,"Les routes principales"],`, dessinées en gris, ont étés classifiées automatiquement
à partir de données issues d'`,[1,"OpenStreetMap"],", vous pouvez toutefois re-classifier un segment de route en cliquant dessus."],`Les routes principales sont typiquement plus adaptés pour un plus
gros volume de circulation que les routes résidentielles.`,"Cliquez sur une route pour la re-classifier","Changer un segment","Re-classifier plusieurs routes en dessinant un tracé qui les suit","Marquer comme principale le long d'un tracé","Effacer une classification comme principale","Effacer toutes les routes principale",`Certaines zones du quartier ne sont pas accessibles en voiture, affichées en
rouge`,"Style de la carte",[[0]," Animer les raccourcis",[1,"1"]],[[0]," Afficher les entrées des cellules",[1,"2"]],[[0]," L'épaisseur des routes dépends des raccourcis",[1,"1"]],"Dessiner les routes :","Pires raccourcis","Cellule","Modifications (filtres ou sens)","Limite de vitesse","Stats du quartier",[[0]," Cliquez pour ajouter un filtre modal"],"Cliquez pour changer le sens","Cliquez pour définir une route principale ou non","Click to create a turn restriction from here","Click to delete filter","Click to delete turn restriction","Add turn restriction",[[0]," Create a turn restriction from ",0," to ",1],["Language ",[0,[0,"English"]," ",[1,"Français"]," ",[2,"Magyar"]]],[[0]," Language ",[1,[0,"English"]," ",[1,"Français"]," ",[2,"Magyar"]]],[`The Connected Neighbourhood Tool helps you design a Low-Traffic
Neighbourhood (LTN). This guide is written specifically for the Scottish
