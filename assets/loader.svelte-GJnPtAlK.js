...
quickly copy a project and switch between projects.`,"Measurement units",["Imperial (mph) ",[0]," Metric (km/h)"],["Speed limit (",0,")"],[0," shortcuts through ",1," (",2,")"],["Main road: ",0," (",1,")"],[[0]," Language"],"English","Français","Magyar","Speed units",[[0]," Hide small cells",[1,"3"]],"Empty so far. Click a coloured area to get started."];export{e as c};
